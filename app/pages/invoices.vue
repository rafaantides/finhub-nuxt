...
import type { InvoiceApiResponse, InvoiceResponse } from '~/types'
...
const { data, status } = useFetch<InvoiceApiResponse>('/api/invoices', {
  query,
  lazy: true
})
...
function getRowItems(row: Row<InvoiceResponse>) {
  return [
    {
      type: 'label',
      label: 'Actions'
